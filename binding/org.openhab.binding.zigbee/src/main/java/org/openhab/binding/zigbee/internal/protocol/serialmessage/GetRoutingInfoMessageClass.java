 ...
 * @since 1.5.0
 */
public class GetRoutingInfoMessageClass extends ZigbeeCommandProcessor {
	...
	public boolean handleResponse(ZigbeeController zController, SerialMessage lastSentMessage, SerialMessage incomingMessage) {
		...
		zController.notifyEventListeners(new ZigbeeNetworkEvent(ZigbeeNetworkEvent.Type.NodeRoutingInfo, nodeId,
				ZigbeeNetworkEvent.State.Success));
