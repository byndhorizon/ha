...
public class ZigbeeBasicCommandClass extends ZigbeeCommandClass implements ZigbeeBasicCommands {
	...
	/**
	 * Creates a new instance of the ZigbeeBasicCommandClass class.
	 * @param node the node this command class belongs to
	 * @param controller the controller to use
	 * @param endpoint the endpoint this Command class belongs to
	 */
	public ZigbeeBasicCommandClass(ZigbeeNode node,
