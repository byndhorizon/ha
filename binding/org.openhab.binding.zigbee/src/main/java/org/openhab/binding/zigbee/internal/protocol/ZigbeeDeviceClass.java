...
/**
 * Zigbee device class. A Zigbee device class groups devices with the same
...
public class ZigbeeDeviceClass {

	private static final Logger logger = LoggerFactory.getLogger(ZigbeeDeviceClass.class);
	...
	/**
	 * Constructor. Creates a new instance of the Zigbee device class.
	 ...
	 */
	public ZigbeeDeviceClass(Basic basicDeviceClass, Generic genericDeviceClass, Specific specificDeviceClass){
		logger.trace("Constructing Zigbee Device Class");
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ZigbeeDeviceClass other = (ZigbeeDeviceClass) obj;
	...
	/**
	 * Zigbee basic Device Class enumeration. The Basic Device Class provides
	 * the device with a role in the Zigbee network. 
	 * @author Brian Crosby
	 * @author Jan-Willem Spuij
	 * @since 1.3.0
	 */
	...
	/**
	 * Zigbee Generic Device Class enumeration. The Generic Device Class
...
//					return new CommandClass[] { CommandClass.NO_OPERATION, CommandClass.BASIC, CommandClass.MANUFACTURER_SPECIFIC, CommandClass.VERSION, CommandClass.PROPRIETARY };
	...
	/**
	 * Zigbee Specific Device Class enumeration. Specific Device Classes are 
