 ...
 * @since 1.5.0
 */
public class GetControllerCapabilitiesMessageClass extends ZigbeeCommandProcessor {
	...
	public ZigbeeDeviceType getDeviceType() {
		if(isSecondary) {
			return ZigbeeDeviceType.SECONDARY;
		}
		else {
			if(isSUC)
				return ZigbeeDeviceType.SUC;
			else
				return ZigbeeDeviceType.PRIMARY;
		}
	}
}
