...
public class ZigBeeSerialInterface implements ZToolPacketHandler {
     ...
     */
    public boolean open() {
    	System.out.println("initializeHardware open 0000000000000000");
        if (!serialPort.open(serialPortName, 115200)) {
        	System.out.println("initializeHardware open 000000000000000011111111");
            return false;
        }
        System.out.println("initializeHardware open 11111111111111111");
        parser = new ZToolPacketParser(serialPort.getInputStream(), this);
        System.out.println("initializeHardware open 2222222222222222");
        return true;
    }
