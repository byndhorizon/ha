...
public class ZigBeeApi implements EndpointListener, DeviceListener {
    ...
    public boolean startup() {
    	System.out.println("networkManager.startup()");
        networkManager.startup();
        System.out.println("networkManager.startup() done");
        while (true) {
        	System.out.println("networkManager.getDriverStatus(): "+networkManager.getDriverStatus());
