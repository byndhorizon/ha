...
import org.bubblecloud.zigbee.network.packet.zdo.ZDO_NWK_ADDR_REQ;
...
import java.util.*;
	...
	public class ZigbeeTest {
	    ...
	    static {
	        ...
	        commands.put("permitJoin", new PermitJoinCommand());
	    ...
	    private static class UnsubscribeCommand implements ConsoleCommand {
	        ...
	        public String getSyntax() {
	            return "bind [DEVICE] [CLUSTER]锟絒ATTRIBUTE]";
	        }
	        public boolean process(final ZigBeeApi zigbeeApi, final String[] args) {
	            if (args.length != 4) {
	                return false;
	    ...
	    private static class ReadCommand implements ConsoleCommand {
	        ...
	        public String getSyntax() {
	            return "read [DEVICE] [CLUSTER]锟絒ATTRIBUTE]";
	        }
	        public boolean process(final ZigBeeApi zigbeeApi, final String[] args) {
	            if (args.length != 4) {
	                return false;
	    ...
	    private static class PermitJoinCommand implements ConsoleCommand {
	        public String getDescription() {
	            return "Permit Join.";
	        }
	        ...
	        public boolean process(final ZigBeeApi zigbeeApi, final String[] args) {
	        	ZToolAddress16 corNwkAddress = new ZToolAddress16(0, 0);
...
//	    		}
	    ...
	    private static class DescriptionCommand implements ConsoleCommand {
	        public String getDescription() {
	            return "Description.";
	        }
